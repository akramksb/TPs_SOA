 ...
 * 
 */
@WebServiceClient(name = "BankWs", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8089/BankService?wsdl")
public class BankWs
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8089/BankService?wsdl");
